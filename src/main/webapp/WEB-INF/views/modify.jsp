    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div class="article">
                ...
                <div class="section">
                    <form name="writeForm" method="post" action="modify_ok">
                        <table>
                            <tr>
                                <td id="title">제목</td>
                                <td><input id="title" type="text" name="title" value="${modify_view.title}"><br><span id="titlec" style="color:red;display:none"></span></td>
                                <input style="display:none;" type="text" name="idx" value="${modify_view.no}">
                            </tr>
                            <tr>
                                <td id="contents">내용</td>
                                <td><textarea id="contents" name="contents">${modify_view.contents}</textarea><br><span id="contentsc" style="color:red;display:none"></td>
                            </tr>
                            <tr>
