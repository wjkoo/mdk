...
<html>
        ...
        <script type="text/javascript">
        	function order_check(){
        		...
        		IMP.request_pay({
        		    ...
        		    name : '자,모음카드',
        		    amount : 7500,
        		    buyer_email : 'wjkoo3@naver.com',
        		    buyer_name : '구매자이름',
        		    buyer_tel : '010-2944-4455',
        		    buyer_addr : '경기 하남시 미사강변대로55 2304-203',
        		    buyer_postcode : '12917',
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div class="article">
            	<form name="orderForm" method="post" action="order_ok_2">
                <div class="section2">
                    ...
                    <table id="product">
                        ...
                        <tr id="d">
                        	<td>1</td>    
                            <td><img src="${image_path}" width="70" height="70" style="vertical-align:middle;"> ${card_name}</td>
                            <td>${amount}개</td>
                            <td>${card_price}원</td>
                            <input style="display:none;" type="text" name="cart_no" value="${card_no}">
                            <input style="display:none;" type="text" name="del_no" value="${del_no}">
                ...
                <div class="section3">
					...
					<table id="buyer">
                		...
                		<tr>
                			<td id="t">배송 메모</td><td id="d"><textarea style="width:400px; height:50px;"></textarea></td>
                		</tr>
                	</table>
                </div>
                <div class="section4">
